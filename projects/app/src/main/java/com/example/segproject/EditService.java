...
public class EditService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                deleteServiceDialog(serv.getName(),serv.getServiceID());
                return false;
            }
        });
    ...
    private void deleteServiceDialog(String name,  String servID){
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!editTextRate.getText().toString().trim().matches("^[0-9]*$")){
    ...
    public void updateService(String servID){
        ...
        rate = Double.parseDouble(editTextRate.getText().toString().trim());
